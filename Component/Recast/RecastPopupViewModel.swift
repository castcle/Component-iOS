...
public final class RecastPopupViewModel {
    ...
    public init(isRecasted: Bool = false, page: Page = Page().initCustom(displayName: UserManager.shared.displayName, pageImage: "", castcleId: UserManager.shared.rawCastcleId)) {
