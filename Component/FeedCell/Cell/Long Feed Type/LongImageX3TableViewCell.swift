...
//
//  LongImageX3TableViewCell.swift
//  Component
//
...
public class LongImageX3TableViewCell: UITableViewCell {
...
extension LongImageX3TableViewCell: LightboxControllerPageDelegate {
    public func lightboxController(_ controller: LightboxController, didMoveToPage page: Int) {
        // MARK: - Lightbox Move Page
    }
}

extension LongImageX3TableViewCell: LightboxControllerDismissalDelegate {
