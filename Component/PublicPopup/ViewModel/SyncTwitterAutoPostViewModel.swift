...
//
//  SyncTwitterAutoPostViewModel.swift
//  Component
//
...
final public class SyncTwitterAutoPostViewModel {
    ...
    func syncSocial() {
        self.userRepository.syncSocial(userId: UserManager.shared.castcleId, pageSocial: self.pageSocial) { (success, _, isRefreshToken) in
...
extension SyncTwitterAutoPostViewModel: TokenHelperDelegate {
